  ...
  return (
    <div className="w-full h-screen grid place-items-center">
      <div className="w-2/3 my-6 flex flex-col gap-6">
        <div className="w-full h-96 overflow-y-scroll bg-gray-200 p-6 rounded shadow-xl">
              ...
              dataTest.map((data, index) =>
                index % 2 === 0 ? (
                  <div className="w-full flex justify-end items-center gap-2">
                    <div className="text-sm bg-gray-100 p-3 max-w-[70%] rounded">
                      {data}
                    </div>
                    <p>: You</p>
                  </div>
          ...
          <Button
            onClick={() =>
              axios.get(environment.apiUrl + "/api").then((res) => {
                ...
                setDataTest([...dataTest, res.data.choices[0].message.content]);
              })
            }
          >
            Test OpenAI
